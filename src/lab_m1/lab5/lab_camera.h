    ...
    class Camera
    {
     public:
        ...
        {   
            ...
            // save state
            save_position = glm::vec3(0, 1.5f, -2.5f);
            save_forward = glm::vec3(0, 0, -1);
            save_up = glm::vec3(0, 1, 0);
            save_right = glm::vec3(1, 0, 0);
        ...
        glm::vec3 GetWorldPosition(glm::mat4 projectionMatrix, glm::mat4 modelMatrix)
		{   // calculate the final matrix
            glm::mat4 finalMatrix = projectionMatrix * GetViewMatrix() * modelMatrix;

            // Transform the local position to world space
            glm::vec4 worldPosition = finalMatrix * glm::vec4(GetTargetPosition(), 1.0f);
     ...
     public:
        ...
        glm::vec3 save_position;
        glm::vec3 save_forward;
        glm::vec3 save_right;
        glm::vec3 save_up;
    };
}   // namespace implemented
